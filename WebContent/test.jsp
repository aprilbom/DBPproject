...
<section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="education">
  ...
  font-size:13px; padding:0 0.5em; cursor:pointer; transition:800ms ease all; outline:none; align:center; font-family: 'Nanum Gothic', sans-serif;"> </div>
      ...
      <tr>
      <th style="background-color: #2e53b6; text-align :center"  >과목번호</th><th style="background-color: #2e53b6; text-align :center" >과목명</th><th style="background-color: #2e53b6; text-align :center">분반</th><th style="background-color: #2e53b6; text-align :center">강의실</th><th style="background-color: #2e53b6; text-align :center">시간</th>
      <th style="background-color: #2e53b6; text-align :center">학점</th><th style="background-color: #2e53b6; text-align :center">교수명</th><th width="70px" style="background-color: #2e53b6; text-align :center">신청</th><th width="70px" style="background-color: #2e53b6; text-align :center">정원</th><th width="80px" style="background-color: #2e53b6; text-align :center">수강신청</th>
      </tr> 
      ...
      pstmt = myConn.prepareStatement("select c_id, c_name, c_class, c_day, c_time, p_name from course c, professor p where c.p_id = p.p_id and c.c_id not in (select c_id from enroll where s_id=?)");
         ...
         ResultSet rscomp = pstmt.executeQuery();
