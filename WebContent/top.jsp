...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
      ...
      <span class="d-none d-lg-block">
        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" onclick="javascript:location.href='main.jsp'" src="img/smulogo.png" alt="" href="main.jsp">
      </span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item">
        	<% if (login==1) {%>
        	<a class="nav-link">[학생]: <%=session_id %> 님 접속 중 </a> <% }%>
        </li>
        <li class="nav-item">
