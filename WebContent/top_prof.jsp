...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        <li class="nav-item">
        	<% if (login==1) {%>
        	<a class="nav-link">[교수] : <%=session_id %> 님 접속중</a> <% }%>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="insert_prof.jsp">Open Class</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="see_course_prof.jsp">My Class</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="select_stu_prof.jsp">My Student</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="timetable_prof.jsp">My TimeTable</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="update_prof.jsp">Modify</a>
        </li>
        <li class="nav-item">
